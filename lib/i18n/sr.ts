export const sr = {
  ...
  clientCard: {
    show: "Klijentkinja",
    hide: "Sakrij klijentkinju",
    loading: "Učitavam…",
    failed: "Kartica nije mogla da se učita.",
    completed: "Došla",
    noShow: "Nije došla",
    cancelledByClient: "Otkazala sama",
    cancelledBySalon: "Otkazao salon",
    upcoming: "Zakazano unapred",
    ...
    notesSaved: "Sačuvano.",
    notesTooLong: "Beleška može imati najviše 500 znakova.",
  },
  cancelled: {
